...
{
  private String Kevin, Kevin2, Kevin3;
  ...
  {
    return Kevin + ": " + count1 + " " + Kevin2 + ": " + count2 + " " + Kevin3 + ": " + count3;
  }
  ...
  private int countToDegrees(int count, int total)
  {
    ...
    return (int) (((360.0 * count) / total) + .5);
  }
  ...
  private void drawSector(Graphics g, int x, int y, int r, int fromDegree, int degrees)
  {
    ...
    public static void main(String args[]) {
        PollDisplayPanel votingMachine = new PollDisplayPanel("Alan", "Kevin", "Ryan");
        votingMachine.vote1();
        votingMachine.vote2();
        votingMachine.vote1();
